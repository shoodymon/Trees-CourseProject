...
namespace Trees_CourseProject
{
    public partial class SplashScreen : Window
    {
        ...
        private async void SplashScreenLoadedAsync(object sender, RoutedEventArgs e)
        {
            ...
            fadeInAnimation.Duration = new Duration(TimeSpan.FromSeconds(2)); // Продолжительность анимации в секундах
            ...
            fadeOutAnimation.Duration = new Duration(TimeSpan.FromSeconds(2)); // Продолжительность анимации в секундах
